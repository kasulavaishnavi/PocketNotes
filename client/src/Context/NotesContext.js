...
const NotesContext = ({ children }) => {
  ...
  const getGroups = useCallback(async () => { 
    try {
      const response = await axios.get('https://mongodb+srv://kasulavaishnavi4:Kasula2002@cluster0.dyqj3fj.mongodb.net/api/groups');
...
getGroups()
  ...
  const createGroup = async (name,color) => {
    try {
      const response = await axios.post('https://mongodb+srv://kasulavaishnavi4:Kasula2002@cluster0.dyqj3fj.mongodb.net/api/groups', { name , color });
      getGroups(); 
  ...
  const deleteGroup = async(groupId) =>{
    try {
      await axios.delete(`https://mongodb+srv://kasulavaishnavi4:Kasula2002@cluster0.dyqj3fj.mongodb.net/api/groups/${groupId}`);
      getGroups(); 
  ...
  const getNotes = useCallback(async (groupId) => {
    if (groupId) {
      try {
        const response = await axios.get(`https://mongodb+srv://kasulavaishnavi4:Kasula2002@cluster0.dyqj3fj.mongodb.net/api/group?groupId=${groupId}`); 
  ...
  const createNote = async (noteData) => {
    try {
     const response= await axios.post('https://mongodb+srv://kasulavaishnavi4:Kasula2002@cluster0.dyqj3fj.mongodb.net/api/notes',  noteData ); 
